...
namespace app\common\model {
    ...
    class ArticleModel
    {
        ...
        {
            $_SESSION['comment_count'] = CommentModel::getAllRecordsByArticleId($artid);
        ...
        public function getCurrentPageCommnets($artid, $comment_current_page_index)
        {
            ...
            // 获取当前页评论的数量
            $this->comment_current_page_count = CommentModel::getRecordForCurrentPageByArticleId($artid, COMMENT_PAGE_COUNT, $offset);
            $this->comment_array = CommentModel::getComments();
        ...
        {
            $comment = new CommentModel($artid, $name, $msg, $datetime, $userid, '2');
